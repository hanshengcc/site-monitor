...
async def _save_snapshot_bytes(
    ...
    # Query previous snapshot for this target to determine has_changed
    has_changed = True
    async with AsyncSessionLocal() as session:
        ...
        prev_row = await session.execute(prev_stmt)
...
async def run_snapshots(group: Optional[str] = None):
    """Run scheduled or manual snapshot round for all enabled targets."""
